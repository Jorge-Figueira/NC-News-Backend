const {fetchTopics, fetchArticlesById, upvoteArticle, fetchUsers, fetchCommentsForArticle, fetchArticles} = require('../models/news.models')
...
exports.getArticles = (re, res, next) => {
    fetchArticles()
        .then((articles) => {
